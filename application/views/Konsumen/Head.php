...
<head>
  ...
  <title>UMKM - PPKM</title>

  <link rel="shortcut icon" href="<?=base_url()?>assets/konsumen/favicon.ico">
  <link href="<?=base_url()?>assets/konsumen/css/style.css" media="screen" rel="stylesheet" type="text/css">
