            ...
            <form method="POST" action="<?=base_url()?>Konsumen/Checkout">
              ...
              <tr>
                <td colspan="7" class="cart_but" style="border: none;">
                  <input class="update" type="submit" id="submitButton" value="Checkout" name="submit" style="background: #59b7c2; color: #ffffff; height: 35px; padding: 0 10px; font-size: 16px; float: right;" disabled="disabled"/>
                </td>
              </tr>
            </form>
          </table>
