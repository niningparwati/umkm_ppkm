                ...
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_promo" name="nama_promo" value="<?php echo set_value('nama_promo'); ?>">
                        <?php echo form_error('nama_promo'); ?>
                      </div>
                      <div class="form-group">
                        <label for="stokProduk">Kode Promo</label>
                        <input type="text" name="kode_promo" class="form-control" value="<?php echo set_value('kode_promo'); ?>">
                        <?php echo form_error('kode_promo'); ?>
                      </div>
                      <div class="form-group">
                        <label for="stokProduk">Besar Promo (%)</label>
                        <input type="number" min="1" name="besar_promo" class="form-control" value="<?php echo set_value('besar_promo'); ?>">
                        <?php echo form_error('besar_promo'); ?>
                      </div>
                       <div class="form-group">
                        <label for="exampleInputEmail1">Berlaku Sampai *Bulan/Tanggal/Tahun</label>
                        <input type="date" name="berlaku_sampai" class="form-control" id="Tanggal"  value="<?php echo set_value('berlaku_sampai'); ?>">
                  ...
                  <div class="col-md-6">                    
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control uang" id="rupiah" name="minimal_belanja" value="<?php echo set_value('minimal_belanja'); ?>" >
                        <?php echo form_error('minimal_belanja'); ?>
                      </div>
                        <div class="form-group">
                        <label for="harga">Maksimal Potongan</label>
                        <input type="text" class="form-control uang" id="rupiah2" name="maksimum_potongan" value="<?php echo set_value('maksimum_potongan'); ?>" >
