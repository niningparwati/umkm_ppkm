        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
               <img class="profile-user-img img-responsive img-circle" src="<?=base_url()?>uploads/foto_konsumen/<?php echo $konsumen->foto_konsumen ?>" alt="User profile picture">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Tanggal Pendaftaran</b> <a class="pull-right"><?php echo $konsumen->tanggal_join ?></a>
                </li>
                <li class="list-group-item">
