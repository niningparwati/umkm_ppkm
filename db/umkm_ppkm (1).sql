...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jun 2020 pada 01.55
...
('', 'Penghargaan UMKM Terfavorit', 'Administrator.png', 'penghargaan yang didapatkan pada saat award UMKM di Provinsi Jawa Barat', 'Bandung', '2019-01-20', 1);
...
CREATE TABLE `tb_transaksi` (
  ...
  `status` enum('menunggu pembayaran','menunggu konfirmasi','diproses','dikirim','diterima','dana dikirim','selesai') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
