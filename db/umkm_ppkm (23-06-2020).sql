...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Jun 2020 pada 11.54
...
(3, 'Pizza Lokal', '', 'Menjual pizza dengan hasil karya lokal', 35000, 7, 1, 1, '1'),
...
(1, NULL, 'Promo Pertama', 'HJKL001SAS', 10, 100000, 20000, 'aktif', 'pay-per-click.png', '2020-06-30'),
...
(2, 1, 105000, NULL, 0, '', '', '', '', '', 0, '', '', '2020-06-23 04:38:12', 'menunggu pembayaran');
