...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2020 at 03:48 PM
...
(3, 'wsfvhdjfvkkk', '', 'bhwrhagfhasbfhas', 'Sukapuraa', '2020-06-12', 2);
...
(3, 'Pizza Lokal', 'pizaa.jpg', 'Menjual pizza dengan hasil karya lokal', 35000, 7, 1, 1, '1'),
(4, 'Pizza Kueh Kering', 'IMG_20512.jpg', 'berbagai kue kering khas lebaran', 30000, 9, 1, 1, '1'),
(5, 'Nasi Liwet', 'umkm1.PNG', 'berbagai macam nasi liwet lezat', 35000, 20, 1, 1, '1'),
(6, 'Gulaku', '', 'Gula pasir 250g', 15000, 100, 2, 4, '1'),
...
INSERT INTO `tb_transaksi` (`id_transaksi`, `id_konsumen`, `total_harga`, `provinsi`, `kota`, `detail_alamat`, `ekspedisi_pengiriman`, `estimasi_pengiriman`, `ongkos_kirim`, `bukti_pembayaran`, `resi`, `tanggal_transaksi`, `status`) VALUES
(1, 1, 300000, 'Jawa Barat', 'Bandung', 'Jl. Adyaksha Raya', 'JNT', '', 11000, '', 'JNT95883759834', '2020-06-08 16:29:15', 'selesai');
